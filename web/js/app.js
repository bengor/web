...
var _bengorCookies = require('bengor-cookies');
...
},{"bengor-cookies":3,"fastclick":4,"lin3s-event-bus":11,"svg4everybody":12}],2:[function(require,module,exports){
'use strict';
...
function prepend(element, content) {
  var evalContent = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
...
var _arrayFrom = __webpack_require__(5);

var _arrayFrom2 = _interopRequireDefault(_arrayFrom);

var _CookieHelpers = __webpack_require__(7);

var CookieHelpers = _interopRequireWildcard(_CookieHelpers);

var _DomHelpers = __webpack_require__(0);
...
var Cookies = function Cookies() {
  ...
  var triggers = _ref$triggers === undefined ? 'html' : _ref$triggers;
  var _ref$maxPageYOffset = _ref.maxPageYOffset;
  var maxPageYOffset = _ref$maxPageYOffset === undefined ? false : _ref$maxPageYOffset;
  ...
  this.events = ['click', 'touchstart', 'mousewheel'];
  this.cookieName = 'bengor-cookie';

  this.removeEventListeners = function () {
    _this.events.map(function (event) {
      _this.triggers.map(function (trigger) {
        trigger.removeEventListener(event, _this.onScrollAccept, true);
        trigger.removeEventListener(event, _this.onClickAccept, true);
      });
    });
  };

  this.onScrollAccept = function (event) {
    _this.scrollMovement += event.deltaY;
    if (_this.scrollMovement > _this.maxPageYOffset) {
      _this.onClickAccept();
    }
  };

  this.onClickAccept = function () {
    _this.accept();

    _this.removeEventListeners();
  };

  this.enableInteraction = function (events, callback) {
  ...
  this.show = function () {
    if (!CookieHelpers.get(_this.cookieName)) {
      DomHelpers.addClass(_this.element, 'bengor-cookies--visible');
    } else {
  ...
  this.accept = function () {
    CookieHelpers.create(_this.cookieName, Math.floor(Math.random() * 100000000 + 1), 30);

    _this.plugins.map(function (plugin) {
      plugin.execute();
    });

    DomHelpers.removeClass(_this.element, 'bengor-cookies--visible');
  };
  ...
  this.triggers = [].concat(_toConsumableArray(document.querySelectorAll(triggers)));
...
var _GoogleTagManager = __webpack_require__(8);
...
var GoogleTagManager = function () {
  ...
  _createClass(GoogleTagManager, [{
    ...
    value: function execute() {
      ...
      var tagManagerScript = '(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({"gtm.start":' + 'new Date().getTime(),event:"gtm.js"});var f=d.getElementsByTagName(s)[0],' + 'j=d.createElement(s),dl=l!="dataLayer"?"&l="+l:"";j.async=true;j.src=' + '"//www.googletagmanager.com/gtm.js?id="+i+dl;f.parentNode.insertBefore(j,f);' + '})(window,document,"script","dataLayer","' + this.id + '");',
...
exports.BenGorCookiesTemplates = exports.BenGorCookiesPlugins = exports.BenGorCookies = undefined;
...
var BenGorCookiesPlugins = _interopRequireWildcard(_Plugins);

var _Templates = __webpack_require__(3);

var BenGorCookiesTemplates = _interopRequireWildcard(_Templates);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.BenGorCookies = _Cookies2.default;
exports.BenGorCookiesPlugins = BenGorCookiesPlugins;
exports.BenGorCookiesTemplates = BenGorCookiesTemplates;
...
},{"./Event":7,"./EventTypes":10}],6:[function(require,module,exports){
/*
 * This file is part of the EventBusJS library.
 *
 * Copyright (c) 2016 LIN3S <info@lin3s.com>
...
var DOMReadyEventSubscriber = function (_EventSubscriber) {
  ...
  function DOMReadyEventSubscriber(aCallback) {
    ...
    return _possibleConstructorReturn(this, (DOMReadyEventSubscriber.__proto__ || Object.getPrototypeOf(DOMReadyEventSubscriber)).call(this, aCallback));
  }
...
},{"./DOMReadyEvent":5,"./EventSubscriber":9}],7:[function(require,module,exports){
/*
 * This file is part of the EventBusJS library.
 *
 * Copyright (c) 2016 LIN3S <info@lin3s.com>
...
},{"./DOMReadyEvent":5,"./DOMReadyEventSubscriber":6,"./Event":7,"./EventPublisher":8,"./EventSubscriber":9,"./EventTypes":10}],12:[function(require,module,exports){
